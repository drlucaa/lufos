...
''
    binds {
      ...
      Mod+Space hotkey-overlay-title="Application Launcher" { spawn "walker"; }

      // === Ignis Controls ===
      Mod+M hotkey-overlay-title="Task Manager" { spawn "ghostty" "btop"; }
      ...
      // Color picker
      Mod+Ctrl+C { spawn-sh "niri msg pick-color | grep 'Hex:' | cut -d' ' -f2 | wl-copy"; }
